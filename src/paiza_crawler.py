...
def run_crawler():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            try:
                # まずコンテナが出るのを待つ
                page_list.wait_for_selector(
                    sidebar_selector, state="visible", timeout=10000
                )
                ...
                page_list.wait_for_selector(
                    list_item_selector, state="attached", timeout=10000
                )
            ...
            for i in range(target_count):
                ...
                try:
                    ...
                    if not title_text or "もっと見る" in title_text:
                        continue
                    ...
                    job_url = (
                        f"https://paiza.jp{job_url_suffix}"
                        if not job_url_suffix.startswith("http")
                        else job_url_suffix
                    )
